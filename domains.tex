...
%In $\mathbb Z[\sqrt{5} i]$, we know that $(1 + \sqrt{5} i)(1 - \sqrt{5} i) = 6 = 2 \cot 3$.  Therefore, $1 + \sqrt{5} i$ divides 6.  However, $1 + \sqrt{5} i$ does not divide 2 or 3.  The last fact can be argued directly or by using norms.
