...
%This example may need to be fixed. Suggested by R. Beezer.  TWJ 5/15/2012
%In $\mathbb Z[\sqrt{3} i]$, we know that $(1 + \sqrt{3} i)(1 - \sqrt{3} i) = 4 = 2 \cot 2$.  Therefore, $1 + \sqrt{3} i$ divides 4.  However, $1 + \sqrt{3} i$ does not divide 2.  Thus, $1 + \sqrt{3} i$ is not prime.  Now suppose that $1 + \sqrt{3} i$ is reducible.  Then
%\[
%1 + \sqrt{3} i = (a + b \sqrt{3} i)(c + d \sqrt{3} i)
%\]
%and suppose that $a + b \sqrt{3} i$ is not a unit.  We must show that $c + d \sqrt{3} i$ is a unit.
...
\]
in $D[x]$.  Then the {\bfi content\/}\index{Polynomial!content of} of $p(x)$ is the greatest common divisor of $a_0, \ldots, a_n$.  We say
