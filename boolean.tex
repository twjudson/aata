...
Let $X$ be any set.  We will define the {\bfi power set\/}\index{Power set} of $X$ to be the set of all subsets of $X$. We denote the power set of $X$ by ${\mathcal P}(X)$. For example, let $X = \{ a, b, c \}$.  Then ${\mathcal P}(X)$ is  the set of all subsets of the set  $\{ a, b, c \}$: 
\[
\begin{array}{cccc}
\emptyset & \{ a \} & \{ b \} & \{ c \} \\
\{ a, b \} & \{ a, c\} &\{ b, c\} & \{ a, b, c \}.
...
\item[{\bf [1]}]  %Out of print - TWJ 8/19/2010
...
\item[{\bf [4]}] %Out of print - TWJ 8/19/2010
Hohn, F. {\it Applied Boolean Algebra}. 2nd ed. Macmillan, New York,
1966. 
  
 
\item[{\bf [5]}] %Reference updated - TWJ 8/19/2010
Lidl, R. and Pilz, G. 
