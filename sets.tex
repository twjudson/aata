...
Suppose $A$ is a universal set and we know everything there is to know about this set and all of its subsets and its properties and everything else there is to know.  Then we can prove anything.
\end{example}
...
\begin{theorem}[De Morgan's Laws]\index{De Morgan's laws!for sets}\label{sets_theorem_2}
...
\begin{theorem}\label{sets_theorem_3}
...
\begin{theorem}\label{sets_theorem_4}
