...
Sage exercises Copyright 2011, Robert A. Beezer, \href{http://www.gnu.org/licenses/fdl.html}{GFDL} License\par
\input{./sage/exercises/#3.tex}%
}
}
...
\begin{sageverbatim}
sage: version()
'Sage Version 4.7.1.rc0, Release Date: 2011-07-13'
\end{sageverbatim}
%
This version of the supplement is very new and there are a few commands we have used which are not yet officially incorporated into Sage.  Most everything you will need should be incorporated into Version 4.7.1.
%
\begin{sageverbatim}
\end{sageverbatim}
%
