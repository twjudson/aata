...
\begin{theorem}[Division Algorithm]\index{Division algorithm!for integers}\label{integers_theorem_division_alg}
...
\begin{theorem}[Euclid]\label{integers_theorem_inifinite_primes}
