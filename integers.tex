...
\section{The Division Algorithm}\label{integers_section_2}

An application of the Principle of Well-Ordering that we will use often is the division algorithm. 

\begin{theorem}[Division Algorithm]\index{Division algorithm!for integers}\label{integers_theorem_3}
...
\begin{theorem} {\bf (Fundamental Theorem of Arithmetic)}\index{Fundamental Theorem!of Arithmetic} \label{integers_theorem_8}
...
\item
{\bf Power Sets.} 
Let $X$ be a set.  Define the {\bfi power set\/}\index{Power set} of $X$, denoted ${\cal P}(X)$\label{powerset}, to be the set of all subsets  of $X$.  For example,  
$$
